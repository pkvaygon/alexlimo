...
export default function Blog(){
    const images = [
    {
        ...
        description: `Elite Luxury Limousine is the premier service to utilize for airport transportation service whether it’s to or from the airport. We serve
    ...
    },
    {
        ...
        description: `Elite Luxury Limousine offers charter services in order to afford you a way to explore in luxury many well-known beautiful and
