...
export default function Blog(){
    const images = [
    {
        ...
        description: `Elite Luxury Limo is the premier service to utilize for airport transportation service whether it’s to or from the airport. We serve
    ...
    },
    {
        ...
        description: `Elite Luxury Limo is committed to providing our corporate limo service clientele with the best corporate transportation service
    ...
    },
    {
        ...
        description: `Elite Luxury Limo offers charter services in order to afford you a way to explore in luxury many well-known beautiful and
    ...
    },
    {
        ...
        description: `Elite Luxury Limo specializes in providing you the highest level of professional transportation limousine services for any and all
